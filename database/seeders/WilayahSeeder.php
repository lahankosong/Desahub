...
{
    /**
     * Seed provinces and commonly referenced regions.
     * For full data (kabupaten, kecamatan, desa), use:
     * php artisan wilayah:import
     */
    public function run(): void
    {
        // 38 Provinces of Indonesia (2024)
        $provinces = [
            ['kode' => '11', 'nama' => 'ACEH'],
            ...
            ['kode' => '34', 'nama' => 'DAERAH ISTIMEWA YOGYAKARTA'],
        ...
        DB::table('wilayah_provinsi')->insertOrIgnore($provinces);

        $this->command->info('✓ WilayahSeeder: 38 provinces seeded.');
        $this->command->warn('  For full data (kabupaten, kecamatan, desa), run: php artisan wilayah:import');
    }
}