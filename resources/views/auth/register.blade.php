...
<div class="min-vh-100 d-flex align-items-center justify-content-center">
    <div class="col-md-5 col-lg-4">
        <div class="card shadow">
            <div class="card-body p-4">
                ...
                <form method="POST" action="/{{ $role }}/register">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">OTP akan dikirim ke email ini</small>
                    </div>
            ...
            <hr class="my-3">
            <a href="/{{ $role }}/auth/google" class="btn btn-outline-dark w-100 d-flex align-items-center justify-content-center gap-2">
