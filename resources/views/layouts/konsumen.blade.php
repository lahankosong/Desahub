...
<head>
    ...
    <meta name="theme-color" content="#E8A23C">
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    <meta name="apple-mobile-web-app-title" content="Derum Belanja">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="/konsumen">🛒 Derum — Belanja Deket Rumah</a>
            @auth
    ...
    <nav class="bottom-nav d-flex justify-content-around">
        <a href="{{ route('konsumen.dashboard') }}" class="{{ request()->routeIs('konsumen.dashboard') ? 'active' : '' }}">
            <i class="bi bi-house-door{{ request()->routeIs('konsumen.dashboard') ? '-fill' : '' }}"></i>Beranda
        </a>
        <a href="{{ route('konsumen.outlet') }}" class="{{ request()->routeIs('konsumen.outlet') ? 'active' : '' }}">
            <i class="bi bi-shop{{ request()->routeIs('konsumen.outlet') ? '-fill' : '' }}"></i>Warung
        </a>
        <a href="{{ route('konsumen.order') }}" class="{{ request()->routeIs('konsumen.order') ? 'active' : '' }}">
            <i class="bi bi-receipt{{ request()->routeIs('konsumen.order') ? '-fill' : '' }}"></i>Order
        </a>
        <a href="{{ route('konsumen.profil') }}" class="{{ request()->routeIs('konsumen.profil') ? 'active' : '' }}">
            <i class="bi bi-person{{ request()->routeIs('konsumen.profil') ? '-fill' : '' }}"></i>Profil
        </a>
    </nav>
